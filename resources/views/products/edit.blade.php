...
<body>
    ...
    <form class="product-form" action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="actions">
            ...
            <a class="button-link button-secondary" href="{{ route('products.show', $product->id) }}">詳細へ戻る</a>
        </div>
    </form>
</body>
</html>
